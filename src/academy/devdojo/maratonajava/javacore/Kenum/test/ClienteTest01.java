...
public class ClienteTest01 {
    public static void main(String[] args) {
        ...
        Cliente cliente1 = new Cliente("Goenji", TipoCliente.PESSOA_FISICA, TipoPagamento.CREDITO);
        Cliente cliente2 = new Cliente("Fubuki", TipoCliente.PESSOA_JURIDICA, TipoPagamento.DEBITO);
