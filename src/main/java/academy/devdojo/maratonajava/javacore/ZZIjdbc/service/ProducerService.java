...
public class ProducerService {
    ...
    public static void update(Producer producer){
        requireValidId(producer.getProducer_id());
    ...
    public static List<Producer> findByName(String nameSearch){
        return ProducerRepository.findByName(nameSearch);
    }
    ...
    public static List<Producer> findByNameAndUpdateToUpperCase(String nameSearch){
        return ProducerRepository.findByNameAndUpdateToUpperCase(nameSearch);
    }
    public static List<Producer> findByNameAndInsertWhenNotFound(String nameSearch) {
        return ProducerRepository.findByNameAndInsertWhenNotFound(nameSearch);
    }
        public static void findByNameAndDelete(String nameSearch){
        ProducerRepository.findByNameAndDelete(nameSearch);
    }
}
