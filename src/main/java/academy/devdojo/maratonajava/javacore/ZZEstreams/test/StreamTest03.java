...
public class StreamTest03 {
    ...
    public static void main(String[] args) {
        Stream<LightNovel> stream = listNovels.stream();
        listNovels.forEach(System.out::println);
        System.out.println("_____________________________");
        long count = stream.filter(ln -> ln.getPrice() <= 400)
                .count();
        System.out.println(count);
        long count1 = listNovels.stream()
                .distinct()
